    ...
    return (
      ...
      >
        <div className="popup__input-container">
          <input
            ref={inputElement}
            className={`popup__form-field popup__form-field_input_link ${isInputValid.avatar === undefined || isInputValid.avatar ? '' : 'popup__form-field_invalid'}`}
            name="avatar"
            type="url"
          ...
          />
          <span id="nickname-error" className="error">{errors.avatar}</span>
        </div>
      </PopupWithForm>
