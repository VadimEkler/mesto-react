    ...
    return(
      ...
      >
        <div className="popup__input-container">
          <input
            className={`popup__form-field popup__form-field_input_title ${isInputValid.name === undefined || isInputValid.name ? '' : 'popup__form-field_invalid'}`}
            name="name"
            type="text"
        ...
        <div className="popup__input-container">
          <input
            className={`popup__form-field popup__form-field_input_link ${isInputValid.link === undefined || isInputValid.link ? '' : 'popup__form-field_invalid'}`}
            name="link"
            type="url"
